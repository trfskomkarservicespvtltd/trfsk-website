      ...
      <div className="fixed left-0 right-0 top-0 z-50 border-b border-slate-800 bg-slate-950/95 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-6 lg:flex">
            ...
            <Link href="/home" className="text-sm font-medium text-slate-400 hover:text-white">
              Home
            </Link>
            <Link href="/admin/partners" className="text-sm font-medium text-slate-400 hover:text-white">
              Partners
            </Link>
            <Link href="/admin/kyc" className="text-sm font-medium text-slate-400 hover:text-white">
              KYC Approvals
            </Link>
