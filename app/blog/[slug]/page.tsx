    ...
    <>
      ...
      <article className="py-12 px-4 md:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Content */}
          <div className="prose prose-invert prose-blue max-w-none mb-12 prose-headings:font-bold prose-a:text-blue-400">
          ...
          {/* Author Box */}
          <div className="rounded-3xl border border-slate-800 bg-slate-900/70 backdrop-blur-xl p-8 mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedPosts.map((relatedPost) => (
                  <Link
                    ...
                    className="group"
                  >
                    <div className="rounded-3xl border border-slate-800 bg-slate-900/70 backdrop-blur-xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:border-blue-500/40">
